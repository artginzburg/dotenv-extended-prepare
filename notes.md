This library takes schemas (and part of the name) from [`dotenv-extended`](https://npm.im/dotenv-extended), which is an irreplaceable addition to [`dotenv`](https://npm.im/dotenv).
